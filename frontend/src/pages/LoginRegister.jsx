    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-indigo-100 via-purple-100 to-cyan-100 px-4">
      ...
      >
        ...
        <p className="text-gray-500 text-center mb-6">
          {isAdminMode
            ? isLogin ? "Sign in to manage your platform" : "Create an admin account"
            : isLogin
        ...
        <button
          ...
          disabled={loading}
          className="w-full mt-6 bg-linear-to-r from-indigo-500 to-purple-600 text-white py-3 rounded-xl font-bold hover:scale-105 transition shadow-lg disabled:opacity-60 flex items-center justify-center gap-2"
        >
          {loading ? (
            <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" />
          ) : isAdminMode ? (
            <><FaUserShield /> {isLogin ? "Admin Login" : "Register as Admin"}</>
          ) : (
